...
public class HowlingStrike extends AttackPower {
	/**
	 * 
	 */
	...
	public boolean isBasicAttack() {
		// TODO: The book says you have to be charging in order to use it as a basic attack.
		return true;
	}
