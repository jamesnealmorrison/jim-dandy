...
public class StonesEndurance extends AttackPower {
	...
	public boolean process(Creature user) {
		user.setTemporaryDamageResistance(5, user.getCurrentTurn(), DurationType.END_OF_NEXT_TURN, user, TemporaryEffectType.DMG_RESIST, TemporaryEffectReason.STONES_ENDURANCE, DamageType.ALL);
		timesUsed++;
		return true;
	}
