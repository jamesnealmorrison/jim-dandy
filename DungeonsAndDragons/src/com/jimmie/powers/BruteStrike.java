...
public class BruteStrike extends AttackPower {
	/**
	 * 
	 */
	...
	public List<EffectType> getEffectTypes() {
		...
		effectTypes.add(EffectType.RELIABLE);  // TODO: This means that if you miss, you don't expend the use of the power.  Code this still.
		return effectTypes;
	}
