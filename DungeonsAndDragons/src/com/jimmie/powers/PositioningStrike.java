...
public class PositioningStrike extends AttackPower {
	/**
	 * 
	 */
	...
	public boolean meetsRequirementsToUsePower(Creature user) {
		...
		for (ReadiedWeapon readiedWeapon : user.getReadiedWeapons().values()) {
			if (readiedWeapon.getWeapon().getWeaponGroups().contains(WeaponGroup.LIGHT_BLADE)) {
				return true;
			}
		}
		return false;
