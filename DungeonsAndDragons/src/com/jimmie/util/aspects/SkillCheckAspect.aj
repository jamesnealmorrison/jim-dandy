...
public aspect SkillCheckAspect {
	public pointcut skillCheck(Creature creature) : execution(int com.jimmie.domain.creatures.Creature.skillCheckRoll(..))
	&& this(creature);
	
	int around(Creature creature) : skillCheck(creature) {
