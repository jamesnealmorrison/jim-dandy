...
public class PlanarPortal extends Ritual {
	/**
	 * 
	 */
	...
	public Price getComponentCostPrice() {
		return new Price(5000, CoinType.GOLD_PIECE);
	}

	@Override
	public Price getMarketPrice() {
		return new Price(17000, CoinType.GOLD_PIECE);
	}
