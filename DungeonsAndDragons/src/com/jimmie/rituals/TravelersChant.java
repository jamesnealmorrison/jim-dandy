...
public class TravelersChant extends Ritual {
	/**
	 * 
	 */
	...
	public Price getComponentCostPrice() {
		return new Price(10, CoinType.GOLD_PIECE); // TODO Plus...
	}

	@Override
	public Price getMarketPrice() {
		return new Price(75, CoinType.GOLD_PIECE);
	}
